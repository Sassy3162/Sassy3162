...
gg.clearResults()
gg.setRanges(gg.REGION_C_ALLOC)
gg.searchNumber("132617;134656",gg.TYPE_DWORD)
gg.getResults(10000, nil, nil, nil, nil, nil, nil, nil, nil)
gg.editAll("0",gg.TYPE_DWORD)
gg.clearResults()
gg.setRanges(gg.REGION_C_ALLOC)
gg.searchNumber("197133;283908",gg.TYPE_DWORD)
gg.getResults(10000, nil, nil, nil, nil, nil, nil, nil, nil)
gg.editAll("0",gg.TYPE_DWORD)
gg.setRanges(gg.REGION_C_ALLOC | gg.REGION_OTHER)
gg.searchNumber("3099885035206084105;274877907202", gg.TYPE_QWORD)
gg.getResults(50000, nil, nil, nil, nil, nil, nil, nil, nil)
...
gg.setVisible(false)
gg.getResults(10000)
gg.searchNumber("1,821688e-43;1,43773222e-42", gg.TYPE_FLOAT, nil, nil, nil, nil)
gg.setVisible(false)
gg.getResults(50000)
...
gg.setVisible(false)
gg.getResults(10000)
gg.searchNumber("2,15519704e-42;3,61535004e-43", gg.TYPE_FLOAT, nil, nil, nil, nil)
gg.setVisible(false)
gg.getResults(50000)
gg.editAll("0", gg.TYPE_FLOAT)
gg.clearResults()
gg.setRanges(gg.REGION_C_ALLOC)
gg.searchNumber("136450",gg.TYPE_DWORD)
gg.getResults(10000, nil, nil, nil, nil, nil, nil, nil, nil)
gg.editAll("0",gg.TYPE_DWORD)
